  ...
  const handleSubmit = async (payload: SnapshotPayload) => {
    ...
    try {
      const journal = await createJournalPreSnapshot({
        ...
        pre_settlement_mode: payload.pre_settlement_mode,
        pre_settlement_asset: payload.pre_settlement_asset,
        pre_contract_size_usd: payload.pre_contract_size_usd,
        pre_contracts: payload.pre_contracts,
        ...
        hedge_down_if_chop: payload.hedge_down_if_chop,
        hedge_down_if_trend: payload.hedge_down_if_trend,
        hedge_down_if_rebound: payload.hedge_down_if_rebound,
