        ...
        <main className="space-y-12 min-w-0">
          ...
          <section id="s3" className="scroll-mt-20">
            ...
            <section id="s3-1" className="scroll-mt-20">
              ...
              <P>无知之幕在倒放下同样成立、方向相反：<strong>主观未来 = 真实更早的数据，绝不提前显示</strong>；镜面（本次倒放的起点，自动对齐到 K 线开盘）之后的数据也不显示——正放会话里尚未揭示的部分不会因为倒放而泄露。切换瞬间时钟无跳变；倒放触底会自动预取更早的 K 线，到达已加载最早一根时自动暂停。方向是一种模式：暂停、停止、重新启动之间保持，直到你手动切回正序。倒放中图表不显示成交标记（按真实时间戳定位的标记在镜像轴上会错位）。</P>
              <RedHighlight>
