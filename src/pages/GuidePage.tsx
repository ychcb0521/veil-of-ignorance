          ...
          <section id="s4" className="scroll-mt-20">
            ...
            <section id="s4-3" className="scroll-mt-20">
              ...
              <ul className="list-disc pl-6 text-[14px] text-foreground/90 space-y-1">
                ...
                <li><strong>盈亏概览分左右两栏，各自从上往下读</strong>：左栏是<strong>层层递进的一列</strong>——预期回撤、涨幅、涨幅效率、盈亏比、加仓效率、几何期望、算术期望，与战役封面、列表排序栏同序，上一项是下一项的分母或来源（涨幅效率 = 涨幅 ÷ 预期回撤，加仓效率 = 盈亏比 ÷ 涨幅效率，两个期望都由盈亏比推出）；右栏是结果与仓位——前三是<strong>已实现 P&amp;L、主力开仓名义仓位、最大预期亏损</strong>，第四是<strong>多方总名义仓位</strong>（主多战役里所有多单的名义仓位合计：主力、镜像、加仓都算，还挂着没成交的不算；就是 Legs 表合计行里多单那一组的 Σ 名义仓位；主空战役同理叫「空方总名义仓位」），之后是峰值浮盈（USDT）、杠杆倍数、DSI/USI 贡献（只写这场进了哪一组、占组内 Σb² 的多少，如「USI 12.3%」；均方项 b²/n、样本数都在 ⓘ 说明里）。两栏各 7 项，左右同一行的两项始终齐平、每项只占一行；屏幕窄时并成一栏，先左栏、再右栏。卡片底部不再有「期望口径」脚注：算术期望的胜率统一取 50% 写在算术期望的 ⓘ 里，本场几何期望的资产分母用的是开仓快照还是今日总资产，写在几何期望的 ⓘ 里。</li>
