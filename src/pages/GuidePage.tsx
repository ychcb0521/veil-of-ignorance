        ...
        <main className="space-y-12 min-w-0">
          <section id="s1" className="scroll-mt-20">
            ...
            <div className="space-y-3">
              ...
              <P>
                系统按五层闭环工作：L1 原则层保存长期稳定的交易世界观；L2 规则层把原则转成 if-then；L3 决策记录层固定下单前证据；L4 反思诊断层用错题、战役与评价找近因和根因；L5 元监控层用校准、偏差光谱、太难篮子、规则有效性与 D-score vs R 追踪系统是否真的让你变好。
              </P>
              <Highlight>
                核心目标只有一个：让每一次亏损、每一次忍住不做、每一次历史回填，都能回答“哪里错了、为什么会重复、下次如何被系统拦住”。
              </Highlight>
              <KeyGrid>
                <KeyCard title="训练对象">
