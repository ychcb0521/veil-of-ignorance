          ...
          <section id="s4" className="scroll-mt-20">
            ...
            <section id="s4-3" className="scroll-mt-20">
              ...
              <ul className="list-disc pl-6 text-[14px] text-foreground/90 space-y-1">
                ...
                <li><strong>预期回撤默认看柱状。</strong>柱子按预期回撤百分比的<strong>倒数 100 ÷ D%</strong> 等间距分档（D = 2% → 50）：越往右止损越紧，越往左回撤空间越宽。在 D 上等距分时，0.5%、1%、2% 这些紧止损会挤进同一根柱；换成倒数后它们被拉开。柱脚写倒数区间与场数，图例右侧的汇总另附对应的预期回撤区间；样本够多且有极远的离群值时，最右一根并成「≥ 上界」柱。颜色仍报该战役最终盈亏，悬停读预期回撤、倒数与 b。用面板右上角的「时序 | 柱状」切回时序，选择记进地址栏。</li>
