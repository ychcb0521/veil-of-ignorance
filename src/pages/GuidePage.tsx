              ...
              <div className="overflow-x-auto">
                <table className="w-full text-[11px] my-3 border border-border rounded overflow-hidden">
                  ...
                  <tbody>
                    ...
                    <tr><td className="px-3 py-2 border-t border-border">预测胜率</td><td className="px-3 py-2 border-t border-border">Tetlock 式校准训练</td><td className="px-3 py-2 border-t border-border">必须给出具体概率，平仓后进入 Calibration 计算校准分数</td></tr>
