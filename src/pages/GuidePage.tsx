...
function FlowNode({ children, accent, star }: { children: ReactNode; accent?: boolean; star?: boolean }) {
  return (
    <div
      className={`relative bg-card border rounded p-3 text-[12px] text-center max-w-[520px] mx-auto ${
        ...
        <main className="space-y-12 min-w-0">
          <section id="s1" className="scroll-mt-20">
            ...
            <div className="space-y-3">
              ...
              <P>
                "无知之幕"的字面含义：在回放过程中，你永远看不到未来——K 线按真实时间 1:1
                流速推进，不会暴露你尚未抵达的数据。
              </P>
            </div>
          </section>
          ...
          <section id="s3" className="scroll-mt-20">
            ...
            <section id="s3-4" className="scroll-mt-20">
              ...
              <div className="space-y-3">
                ...
                <P>
                  <strong>开仓快照里要填什么（按顺序）</strong>：
                </P>
                <ol className="list-decimal pl-6 text-[14px] text-foreground/90 space-y-1">
                  <li>
                    <Star /> <strong>订单类型</strong> 必选——主力单 / 对冲单（详见 §3.6）
                  </li>
                  <li>
                    <Star /> <strong>仓位模式</strong> 必选——必须为"逐仓"。选"全仓"时确认按钮永久置灰（详见 §3.7）
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>心态自评 1-5 分</strong>——所有订单必填；≤2 分时需勾选"仍坚持交易"才能解锁确认按钮
                  </li>
                  <li>
                    <strong>心态触发原因</strong>（条件显示：心态 ≤3 时必填）
                  </li>
                  <li>
                    <strong>当时对风险的认识</strong>（仅主力单）
                  </li>
                  <li>
                    <strong>当时对风险的管理方式</strong>（仅主力单）
                  </li>
                  <li>
                ...
                <P>
                  <strong>关于"最大亏损"为什么是手填而不是由止损价反算</strong>：
                </P>
                <P>
            ...
            <section id="s3-6" className="scroll-mt-20">
              ...
              <div className="space-y-3">
                ...
                <P>
                  如果把两类订单混在一起评价，你会看到"对冲单的 R 倍数普遍偏低"——这不是错误，这是对冲单本来就该长这样。
                </P>
                <P>所以在系统里：</P>
                <ul className="list-disc pl-6 text-[14px] text-foreground/90 space-y-1">
                ...
                <P>
                  同一标的的主力单与对冲单使用同一个杠杆设置——这是系统级的设计约束，符合真实合约市场的杠杆机制。这意味着：
                </P>
            ...
            <section id="s3-7" className="scroll-mt-20">
              ...
              <div className="space-y-3">
                <P>
                  软提示（warning +
                  用户可勾选"我知道风险继续"）和硬约束（无绕过路径）的差异，在反脆弱里属于决策维度的本质区别。
                </P>
                <P>
                  <strong>软提示假设：</strong>{" "}
                  用户在每一次决策时都具有完整的元认知能力——能在情绪上头时仍然冷静评估"我现在是不是该绕过这条规则"。这个假设在认知心理学上是错的。情绪激动的人会系统性地高估自己绕过规则的合理性。
                </P>
                <P>
                  <strong>硬约束假设：</strong>{" "}
                  把规则定下来的是"冷静时的你"，要执行规则的是"情绪上头的你"。前者比后者聪明，所以前者写下的规则不应该被后者动态修改。
                </P>
                <P>
                  这个设计哲学的根源在 Ulysses
                ...
                <div className="space-y-3">
                  <div>
                    <P>
                      <Star /> <strong>全仓模式硬阻断</strong>
                    </P>
                    <P>
                      开仓快照里，如果当前标的的仓位模式为"全仓"，确认按钮永久置灰。提供"一键切换为逐仓"按钮，但不提供任何"仍坚持全仓"的绕过按钮。
                    </P>
                    <P>
                      原因：全仓让单笔爆仓直接拖垮整个账户。在交易训练阶段，应当一律使用逐仓——这是 Taleb
                      意义上"让损失有界"的最低要求。
                    </P>
                  </div>
                  <div>
                    <P>
                      <Star /> <strong>Critical 模式强制规则</strong>
                    </P>
                    <P>
                      同一错误模式 30 天内 ≥3 次且平均亏损时，系统弹出 MandatoryRuleDialog
                      强制要求你写一条新规则。该对话框不可关闭（除"写入规则"或"延后 24 小时"，每个 pattern 最多延后 1
                      次）。
                    </P>
                  </div>
                </div>
          ...
          <section id="s4" className="scroll-mt-20 bg-accent/30 border border-border rounded-lg p-6">
            <div className="flex items-center gap-3 mb-4 flex-wrap">
              <span className="inline-block px-2 py-0.5 rounded text-[10px] bg-[#F0B90B] text-black">核心能力</span>
            ...
            <div className="space-y-8 mt-6">
              <section id="s4-1" className="scroll-mt-20 space-y-3">
                ...
                <div className="space-y-3">
                  <div>
                    <P>
                      <strong>(1) 不是按时间排序，默认按错误模式聚类</strong>——这是和其他交易日记的根本区别。
                    </P>
                    <ul className="list-disc pl-6 text-[14px] text-foreground/90 space-y-1">
                  ...
                  <div>
                    <P>
                      <strong>(2) 每笔交易的元数据完整可见：</strong>
                    </P>
                    <ul className="list-disc pl-6 text-[14px] text-foreground/90 space-y-1">
                      <li>开仓时间 / 平仓时间</li>
                      <li>开仓价 / 平仓价</li>
                      <li>
                        <Star /> <strong>平仓方式</strong>：手动 / 止损 / 止盈 1-3 / 爆仓
                      </li>
                      <li>订单类型：主力 / 对冲</li>
                  ...
                  <div>
                    <P>
                      <strong>(3) 三个视图切换 + 多维度筛选：</strong>
                    </P>
                    <ul className="list-disc pl-6 text-[14px] text-foreground/90 space-y-1">
                      <li>
                        <strong>视图</strong>：按模式（默认）/ 按时间 / 未评价
                      </li>
                      <li>
                        <strong>筛选</strong>：日期范围 / 标的 / 结果 / 错误大类 / 心态范围 / 订单类型
                      </li>
              ...
              <section id="s4-2" className="scroll-mt-20 space-y-3">
                ...
                <ul className="list-disc pl-6 text-[14px] text-foreground/90 space-y-1">
                  ...
                  <li>
                    <Star /> <strong>订单类型分布</strong>——主力单 vs 对冲单的笔数、胜率、平均 R 对比。若对冲单平均 R
                    显著低于主力单，说明你的对冲多在情绪驱动下进行
                  </li>
                  <li>
                    <Star /> <strong>平仓方式分布</strong>——手动/止损/止盈/爆仓的笔数与 R 分布。手动平仓 R
                    系统性低于止盈触发？说明你在截断盈利尾部
                  </li>
                  <li>
                    <Star /> <strong>全仓笔数审计</strong>——守卫上线后该数字应全部为 0；非 0 即报警
                  </li>
                  <li>
                    <strong>事后合理化预警</strong>——开仓理由被事后修改的笔数
                  </li>
                  <li>
                    <strong>深度分析完成率</strong>——完成六步框架的 journal 占比
                  </li>
                  <li>
              ...
              <section id="s4-3" className="scroll-mt-20 space-y-3">
                ...
                <ul className="list-disc pl-6 text-[14px] text-foreground/90 space-y-1">
                  <li>
                    <strong>自动生成</strong>：同一 pattern 30 天 ≥3 次且亏损时，系统通过 MandatoryRuleDialog
                    强制要求你写
                  </li>
                  <li>
                ...
                <P>
                  每次开仓快照打开时，所有"启用 + 已加入 checklist"的规则会自动出现在 checklist
                  列表中，需要勾选才能通过判定。
                </P>
              </section>
              ...
              <section id="s4-4" className="scroll-mt-20 space-y-3">
                ...
                <P>
                  <strong>第二层：用户自定义 pattern。</strong> 每个 pattern 必须配可操作定义（≥10
              ...
              <section id="s4-5" className="scroll-mt-20 space-y-3">
                ...
                <ul className="list-disc pl-6 text-[14px] text-foreground/90 space-y-1">
                  ...
                  <li>
                    <strong>通道 ②：决策</strong> —— 你当时写的开仓理由、止盈、checklist
                    状态、最大亏损金额、杠杆、仓位模式
                  </li>
                  <li>
                    <strong>通道 ③：状态</strong> —— 心态自评、心态触发原因、历史对照
                  </li>
                  <li>
                    <strong>通道 ④：风险认识与管理</strong> —— 你当时怎么想风险，事后对照实际
                  </li>
                  <li>
                    <strong>通道 ⑤：反事实</strong> —— 六步深度分析 + 反事实回放
                  </li>
                </ul>
              ...
              <section id="s4-6" className="scroll-mt-20 space-y-3">
                ...
                <ol className="list-decimal pl-6 text-[14px] text-foreground/90 space-y-1">
                  ...
                  <li>
                    <strong>错误类型</strong> - 一句话归纳错误的类别（同时在标签选择器打 pattern）
                  </li>
                  <li>
                ...
                <P>
                  <strong>Step 6 可一键写入 checklist。</strong> 这是闭环的关键一步。
                </P>
                <Highlight>
                  "绝大多数复盘卡在第 5 步——'我太冲动了'——从不真正到达第 6 步。系统的反脆弱价值，全部在 Step 5 到 Step 6
                  的跳跃。"
                </Highlight>
              </section>
              ...
              <section id="s4-7" className="scroll-mt-20 space-y-3">
                ...
                <P>
                  <strong>注意：</strong>{" "}
                  反事实表单的"止损价"默认为空——这是反事实假设的核心问题之一："如果我用不同的止损位会怎样？"
                </P>
              </section>
            </div>
          </section>
          ...
          <section id="s5" className="scroll-mt-20">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-card border border-border rounded p-6">
                ...
                <FlowArrow />
                <FlowNode accent star>
                  强制快照（订单类型 → 仓位模式硬阻断 → checklist + 你的规则）
                </FlowNode>
                <FlowArrow />
                ...
                <FlowArrow />
                <FlowNode accent star>
                  critical 模式检测 → 强制规则 OR 主动 Step 6 写规则
                </FlowNode>
                <FlowArrow />
              ...
              <P>
                特别要注意 <Star /> 标记的硬约束节点（仓位模式 = 逐仓、心态 ≤2 额外确认、critical
