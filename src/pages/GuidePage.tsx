        ...
        <main className="space-y-12 min-w-0">
          ...
          <section id="s4" className="scroll-mt-20 bg-accent/30 border border-border rounded-lg p-6">
            ...
            <section id="s4-3" className="scroll-mt-20">
              ...
              <P>列表中的每场战役直接显示战役编号、已实现盈亏、盈亏比和真实操作时间。顶部排序默认按<strong>真实操作时间</strong>，也可以按重要性、盈亏比或字母顺序切换；再次点击同一排序项，可在从大到小 / 从小到大之间切换。指标区同时显示<strong>有效战役（数量）</strong>，鼠标悬停后可查看其中盈利、亏损与盈亏平衡战役的数量。这里的操作时间是客观发生时间，不是无知之幕时间机器里的模拟时间。</P>
