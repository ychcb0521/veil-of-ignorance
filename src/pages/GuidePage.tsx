          ...
          <section id="s4" className="scroll-mt-20">
            ...
            <section id="s4-3" className="scroll-mt-20">
              ...
              <ul className="list-disc pl-6 text-[14px] text-foreground/90 space-y-1">
                ...
                <li><strong>镜像止盈图的颜色报的是盈亏，不是档位。</strong>档位已经由横轴（柱状）或纵轴（时序）表达过了，颜色再重复一遍是浪费。改成「这一场最后是赚是亏」之后，每根柱都看得出自己的输赢构成——比如「未实现」那一柱里仍有多少场最终是赚钱的。口径与分档一致：|b| ≤ 0.1 记持平，与尚未结束的战役同为灰色空心圈。</li>
              ...
              <ul className="list-disc pl-6 text-[14px] text-foreground/90 space-y-1">
                ...
                <li><strong>一场战役出现两笔及以上主仓时，以名义金额最大的那笔为准</strong>。M 底仓 + 镜像多单本就是两笔，再加上回填、残仓、试单，主仓多于一笔是常态；此时开仓价、杠杆与「委托」列的归属都跟着<strong>金额最大的那笔</strong>走，而不是序号或时间排在最前的那笔——否则一笔几千 U 的残仓会把上千万 U 的真正主力挤掉，让整份复盘的开仓价与委托归属全部挂错。金额并列时退回最早开仓的那笔，保证结果稳定可复现。</li>
