          ...
          <section id="s4" className="scroll-mt-20">
            ...
            <section id="s4-3" className="scroll-mt-20">
              ...
              <ul className="list-disc pl-6 text-[14px] text-foreground/90 space-y-1">
                ...
                <li><strong>「Δb」列与持仓阶段拆解。</strong>Δb = 该腿盈亏 ÷ 战役初始最大预期亏损 L——这条腿把整场盈亏比 b <strong>推高或拉低了多少个单位</strong>，Σ(各腿 Δb) 恰为战役已实现 b，「b 是如何被增加、如何被削减」由此逐腿可见。更进一步，<strong>一笔持仓不是铁板一块：每一次滚动对冲的结束，意味着这笔持仓一个阶段的完成</strong>。主力与其他多单（包括加仓）下方有浅色的<strong>阶段子行</strong>，<strong>默认折叠</strong>：对应角色标签右边有一个小开关——朝右的箭头加阶段数（如「› 5」，悬停显示「展开 5 个阶段」），点一下展开、箭头转向下，再点收起；各行的开关落在同一条竖线上，每条腿各自记着开合，刷新后回到折叠。阶段子行按各次对冲的平仓时刻把对应持仓切段（边界价即对冲平仓价——同一时刻的市价），每段给出时间区间、起止价、分摊盈亏、贡献率与 Δb。分摊按整条腿的价差权重进行，绝不臆造数字；界面只呈现由对冲结束界定的已完成阶段，腿自身平仓前的<strong>「收尾」阶段一律不呈现</strong>。一笔「整腿 +3.2 万」的持仓可能拆出「对冲结束前 +4.0 万、之后回吐 −0.8 万」——哪一段决策在挣钱、哪一段在回吐，据此可见。贴着该腿平仓结束的对冲不切段；只有一段时不显示子行，角色标签旁也没有阶段开关。PNG 导出同源同列；PNG 导出不跟着折叠，始终画出全部可见阶段子行。</li>
