              ...
              <div className="overflow-x-auto">
                <table className="w-full text-[11px] my-3 border border-border rounded overflow-hidden">
                  ...
                  <tbody>
                    ...
                    <tr><td className="px-3 py-2 border-t border-border">机会质量 Qᵢ / Q̄</td><td className="px-3 py-2 border-t border-border">Qᵢ = 实际盈亏比 bᵢ ÷ 预期回撤百分点 dᵢ；Q̄ = ΣQᵢ ÷ N</td><td className="px-3 py-2 border-t border-border">bᵢ 保留盈亏正负号；dᵢ 优先用平仓回撤评估、缺失时用开仓回撤判断；缺少任一有效数据不纳入统计和排序</td></tr>
