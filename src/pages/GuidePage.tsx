        ...
        <main className="space-y-12 min-w-0">
          ...
          <section id="s3" className="scroll-mt-20">
            ...
            <section id="s3-1" className="scroll-mt-20">
              ...
              <P>顶部 Header「决策记录」前方有一个<strong>倒叙播放</strong>开关，<strong>默认正序</strong>。选中后，时间机器按所选倍速<strong>倒序推进</strong>：K 线逐根回退、当前蜡烛从收盘价缩回开盘价，模拟时间与绑定其上的一切（下单时间、行情、撮合）随之倒走；<strong>客观操作时间除外</strong>——真实世界的操作记录永远向前。切换瞬间时钟无跳变；倒放触底会自动预取更早的 K 线，到达已加载数据最早一根时自动暂停。方向是一种模式：暂停、停止、重新启动之间保持，直到你手动切回正序。</P>
              <RedHighlight>
