        ...
        <main className="space-y-12 min-w-0">
          ...
          <section id="s4" className="scroll-mt-20 bg-accent/30 border border-border rounded-lg p-6">
            ...
            <section id="s4-3" className="scroll-mt-20">
              ...
              <P>战役列表顶部有一组很轻的排序入口，默认按<strong>真实操作时间</strong>排序；也可以按重要性、盈亏比、字母顺序切换，并支持从大到小 / 从小到大双向排序。排序项旁实时显示当前列表的<strong>胜率、平均盈亏比与期望值</strong>：胜率 = 盈利战役 ÷（盈利战役 + 亏损战役）；平均盈亏比是当前列表所有有效单场盈亏比（百分数先还原为数字，亏损保留负号）的算术平均，即盈亏比之和 ÷ 战役数；期望值 E = 胜率 × 平均盈亏比 −（1 − 胜率）。点击期望值可以查看代入后的公式。这里的操作时间指客观发生时间，不是时间机器里的模拟时间。</P>
