...
export const PRE_FIELD_SPECS: SummaryFieldSpec[] = [
  ...
  { key: 'pre_opportunity_quality_payoff_ratio', label: '机会质量判断 · 预期盈亏比 b', type: 'numeric', hint: '数字 5 表示 5:1。' },
  { key: 'pre_opportunity_quality_drawdown_pct', label: '机会质量判断 · 预期最大回撤 d%', type: 'numeric', hint: '按百分点记录，2% 填 2。Q = b ÷ d。' },
...
export const POST_FIELD_SPECS: SummaryFieldSpec[] = [
  ...
  {
    key: 'post_entry_decision_quality',
    label: '决策质量 · 入场',
    type: 'enum',
    optionLabels: DECISION_QUALITY_LABELS,
    optionAccents: DECISION_QUALITY_ACCENTS,
    hint: '只按入场当时可得的信息，评价建仓依据与风险边界。',
    getValue: journal => journal.post_entry_decision_quality ?? journal.post_decision_quality,
  },
  {
    key: 'post_holding_decision_quality',
    label: '决策质量 · 持仓',
    type: 'enum',
    optionLabels: DECISION_QUALITY_LABELS,
    optionAccents: DECISION_QUALITY_ACCENTS,
    hint: '只按持仓过程中可得的信息，评价判断与动作。',
    getValue: journal => journal.post_holding_decision_quality ?? journal.post_decision_quality,
  },
  {
    key: 'post_exit_decision_quality',
    label: '决策质量 · 离场',
    type: 'enum',
    optionLabels: DECISION_QUALITY_LABELS,
    optionAccents: DECISION_QUALITY_ACCENTS,
  ...
  { key: 'post_opportunity_quality_payoff_ratio', label: '机会质量评估 · 预期盈亏比 b', type: 'numeric', hint: '数字 5 表示 5:1。' },
  { key: 'post_opportunity_quality_drawdown_pct', label: '机会质量评估 · 预期最大回撤 d%', type: 'numeric', hint: '按百分点记录，2% 填 2。Q = b ÷ d。' },
